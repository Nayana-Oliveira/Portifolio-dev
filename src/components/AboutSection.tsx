          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`${isVisible ? 'animate-slide-in-right' : 'opacity-0'}`}>
              <div className="space-y-6">
                ...
                e em busca da minha primeira oportunidade no mercado de trabalho. Tenho dedicado meu 
                tempo estudando desenvolvimento web e criando projetos para aplicar meus conhecimentos.
                  </p>
